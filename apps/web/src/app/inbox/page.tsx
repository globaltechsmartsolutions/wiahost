...
import { inboxThreads } from "@/lib/demo-data";
      ...
      <Card className="rounded-[2rem] border-border/80 bg-card/80">
        <CardContent className="space-y-3 p-5">
          {inboxThreads.map((thread) => (
            <div key={thread.guest} className="grid gap-4 rounded-3xl border border-border/80 bg-background/60 p-4 md:grid-cols-[0.8fr_1.3fr_0.4fr] md:items-center">
              <div>
