...
- Audit, automations, workflows, documents, distribution, owners, payments, pricing, settings and statements are covered by artifact-only visual checks for laptop overflow and responsive density.
