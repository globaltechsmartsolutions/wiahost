...
- `/api/health` expone un snapshot JSON de readiness para monitores externos: estado global, checks, estado de base de datos y metadata segura de runtime/deploy. Devuelve 503 solo si una comprobacion critica falla.
