...
- Pendiente inmediato: ejecutar `pnpm eas:login` con cuenta Expo, vincular proyecto con `pnpm eas:configure`, lanzar build preview real, automatizar disparadores push, offline read-only basico y tests e2e mobile.
