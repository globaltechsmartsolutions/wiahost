...
- E2E mobile con Maestro en `apps/mobile/e2e`: suite demo por defecto y suite conectada para login, alta de activo/incidencia, cambios de estado reales en incidencia/tarea/reserva y readiness de push con Supabase.
