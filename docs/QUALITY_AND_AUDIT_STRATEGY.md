...
- Auditoria de accesibilidad con `@axe-core/playwright` sobre rutas publicas, protegidas, audit, calendario, guests, documentos, detalle, edicion de operaciones, owners, statements y settings.
- Baseline visual inicial para landing/auth y check de overflow/alineacion del dashboard, operaciones, editores, audit, calendar/guests, documentos, owners, statements y settings.
...
- Hecho: check visual de audit/automations/documents/owners/payments/settings/statements sin overflow en desktop portatil.
